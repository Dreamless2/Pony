            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Título" value="{{ $filme->getName() }}">
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label">Sinopse</label>
                    <textarea class="form-control" rows="3" placeholder="Sinopse" value="{{ $filme->getOverview() }}"></textarea>
                </div>
